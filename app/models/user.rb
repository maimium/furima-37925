class User < ApplicationRecord
  ...
  validates :family_name,        presence: true,  format: { with:/\A[ぁ-んァ-ン一-龥]/}#, message: "は全角ひらがな/カタカナまたは漢字で入力してください"}
  validates :personal_name,      presence: true,  format: { with:/\A[ぁ-んァ-ン一-龥]/}#, message: "は全角ひらがな/カタカナまたは漢字で入力してください"}
